...
public interface FileDao {
	...
	List<File> getFilesRelTypeCodeAndRelIdAndTypeCodeAndType2Code(@Param("relTypeCode") String relTypeCode,@Param("relId") int relId, @Param("typeCode")  String typeCode,
